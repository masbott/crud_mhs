          ...
          <div id="canvas_dahs" class="demo-placeholder" style="width: 100%; height:270px;">
            <form class="form-horizontal" id="form-mahasiswa" method="POST">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="nim" class="form-control validate" data-deskripsi="NIM" id="inputEmail3" placeholder="NIM">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">Nama</label>
                <div class="col-sm-10">
                  <input type="text" name="nama" class="form-control validate" data-deskripsi="Nama" id="inputPassword3" placeholder="Nama">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">Alamat</label>
                <div class="col-sm-10">
                  <textarea name="alamat" class="form-control validate" data-deskripsi="Alamat" cols="30" rows="10" placeholder="Alamat"></textarea>
                </div>
              </div>
              <div class="form-group">
